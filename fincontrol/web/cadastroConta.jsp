                            ...
                            <div class="card">
                                <form class="form-horizontal m-t-20" action="conta_DB.jsp">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Agência: </label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" name="cod_agencia" value="<%=request.getParameter("cod_agencia") != null?request.getParameter("cod_agencia"):""%>" placeholder="Agência" aria-label="Agência" aria-describedby="basic-addon1" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Número da Conta: </label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="num_cc" value="<%=request.getParameter("num_cc") != null?request.getParameter("num_cc"):""%>" placeholder="Número da Conta" aria-label="Número da Conta" aria-describedby="basic-addon1"  required="required">
                                            </div>
                                        </div>
                                        <div class="form-group row">
